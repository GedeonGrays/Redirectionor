...
public class RedirectionorMixinConfig {
    ...
    public RedirectionorMixinConfig() {
        ...
        this.addMixinRule("net.minecraft.client.tutorial", true);
        ...
        this.addMixinRule("net.minecraft.compat.lithium", isNotLoaded("lithium") && isNotLoaded("roadrunner") && isNotLoaded("canary") && isNotLoaded("radium"));
        ...
        this.addMixinRule("net.minecraftforge", true);
        this.addMixinRule("net.minecraftforge.client", true);
        this.addMixinRule("net.minecraftforge.client.gui", true);
        this.addMixinRule("net.minecraftforge.client.gui.overlay", true);
        this.addMixinRule("net.minecraftforge.client.model", true);
        this.addMixinRule("net.minecraftforge.client.model.generators", true);
        this.addMixinRule("net.minecraftforge.client.model.geometry", true);
        this.addMixinRule("net.minecraftforge.client.settings", true);
        this.addMixinRule("net.minecraftforge.common", true);
        this.addMixinRule("net.minecraftforge.common.data", true);
        this.addMixinRule("net.minecraftforge.common.world", true);
        this.addMixinRule("net.minecraftforge.items.wrapper", true);
        this.addMixinRule("net.minecraftforge.network", true);
    }
